...
insert into item_pedido (quantidade, valorunitario, pedido_id_pedido, produto_id) values (1, 3500.00, 1, 1);
insert into item_pedido (quantidade, valorunitario, pedido_id_pedido, produto_id) values (1, 120.00, 2, 3);
insert into item_pedido (quantidade, valorunitario, pedido_id_pedido, produto_id) values (1, 650.00, 3, 4);
insert into item_pedido (quantidade, valorunitario, pedido_id_pedido, produto_id) values (1, 3500.00, 4, 1);
